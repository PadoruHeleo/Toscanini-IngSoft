...
use crate::pdf::{CotizacionPdfData, InformePdfData, OrdenTrabajoPdfData, EmpresaInfo, ClienteInfo, EquipoInfo, PiezaPdf, TerminoPdf};
use sqlx::Row;
use crate::infrastructure::db::cotizacion as db_cotizacion;

pub async fn get_cotizacion_pdf_data(cotizacion_id: i32) -> Result<CotizacionPdfData, String> {
    db_cotizacion::get_cotizacion_pdf_data(cotizacion_id).await
}
